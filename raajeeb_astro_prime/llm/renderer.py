...
def render_dasha_now(maha: str, antar: str | None) -> str:
    """Render current dasha statement."""
    antar_text = antar or "(antar not found)"
    return f"Current cycle: {maha} Mahadasha with {antar_text} Antardasha influence."
